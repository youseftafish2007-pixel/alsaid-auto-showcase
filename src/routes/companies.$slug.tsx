  ...
  return (
    <>
      <section
        ...
        style={{ background: company.accentSoft }}
      >
        <div className="container-editorial py-14 md:py-20">
          <div className="flex flex-wrap items-center justify-between gap-4 text-[11px] uppercase tracking-[0.22em] text-muted-foreground">
            <div className="flex items-center gap-3">
              <span className="h-px w-8" style={{ background: company.accent }} />
              <span>{company.sector}</span>
            </div>
            <span style={{ color: company.accent }}>{company.number}</span>
          </div>
          <div className="mt-8 grid gap-10 md:grid-cols-12 md:items-end">
            <div className="md:col-span-8">
              <h1 className="max-w-4xl font-display text-5xl leading-[1] tracking-[-0.02em] text-ink md:text-7xl">
            ...
            <div className="md:col-span-4 md:justify-self-end">
              {company.logo ? (
                ...
                <div
                  className="grid h-24 w-24 place-items-center font-display text-2xl tracking-[0.08em] text-paper md:h-28 md:w-28"
      ...
      <section className="border-b border-rule bg-paper-2">
        <div className="container-editorial flex flex-wrap items-center justify-between gap-6 py-8">
          <Link
            to="/companies"
          ...
          >
            <div>
              ...
              <div
                className="font-display text-2xl text-ink transition-colors"
                style={{ ["--hover" as string]: next.accent }}
              >
                {next.name}
              </div>
            </div>
