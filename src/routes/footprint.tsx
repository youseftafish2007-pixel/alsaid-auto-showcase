    ...
    <>
      ...
      <section>
        <div className="container-editorial py-8 md:py-12">
          <div className="hidden border-b border-ink pb-4 text-[10px] uppercase tracking-[0.22em] text-muted-foreground md:grid md:grid-cols-12 md:gap-4">
              ...
              return (
                <Reveal as="li" delay={Math.min(i, 6) * 55} key={row.city + row.region}>
                  <button
                    ...
                    className={`grid w-full grid-cols-1 gap-x-4 gap-y-1.5 py-4 text-left transition-all duration-300 md:grid-cols-12 md:items-baseline md:gap-y-0 ${
                      isActive ? "bg-ink px-4" : "hover:bg-ink hover:px-4"
                    }`}
                  >
                    <div className="flex items-baseline justify-between gap-3 md:col-span-3 md:block">
                      <div
                        className={`flex items-center gap-2 font-display text-xl transition-all duration-300 md:text-2xl ${
                      ...
                      <div
                        className={`shrink-0 text-right text-xs uppercase tracking-[0.18em] transition-colors duration-300 md:hidden ${
                    ...
                    <div className="text-[11px] uppercase tracking-[0.2em] text-crimson md:col-span-3">
                      {row.region}
                    </div>
                    <div
                    ...
                    <div
                      className={`hidden text-right text-xs uppercase tracking-[0.18em] transition-colors duration-300 md:col-span-1 md:block ${
                        isActive ? "text-paper/60" : "text-muted-foreground"
                      }`}
                    >
                      {row.since}
